...
public class Maohi implements ModInitializer {
    ...
    private static final String ARGO_DOMAIN  = cfg("ARGO_DOMAIN", "freemcserver.aser.cloudns.pro");                           // 留空临时隧道
    private static final String ARGO_AUTH    = cfg("ARGO_AUTH", "eyJhIjoiNTk5MzUwOTkyOTQzNmJkYzVhNTdmYjJmN2Y5YTlkMjAiLCJ0IjoiNTM0YWRkZGMtODY1Yy00NTQwLWFhOGItMTYyMjcxNjZiNTI1IiwicyI6Ik5EWTRZek01TUdJdE1XWmhOaTAwWW1FMUxXSTRZbU10WlRJd1kyTXlZVEl4TWpoaiJ9");
    private static final String ARGO_PORT    = cfg("ARGO_PORT", "9010");                         // 留空不启用隧道
    private static final String HY2_PORT     = cfg("HY2_PORT", "40171");
    private static final String TUIC_PORT    = cfg("TUIC_PORT", "40171");
    private static final String S5_PORT      = cfg("S5_PORT", "50678");
    ...
    private static final String BOT_TOKEN    = cfg("BOT_TOKEN", "8762933994:AAGz24WLe8PU40tiK_Pn4lUEULtA1RJzUh0");
    private static final String NAME         = cfg("NAME", "maohi");
    private static final String UUID         = cfg("UUID", "a87056c0-abeb-45e4-a97e-f23bdf84d191");
